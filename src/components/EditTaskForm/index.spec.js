...
describe('EditTaskForm Component', () => {
  ...
  beforeEach(() => {
    ...
    toggleStore.isEditTaskFormActive = true
  })
  ...
  describe('DOM Behavior', () => {
    describe('Component', () => {
      ...
      it('should not render if isEditTaskFormActive is false', () => {
        toggleStore.isEditTaskFormActive = false
        wrapper = mount(Component, {
          global: {
            plugins: [router, pinia, i18n],
            stubs: {
    ...
    describe('return button', () => {
      ...
      it('should call the toggleEditTaskForm method when clicked', async () => {
        const returnButton = wrapper.find('.task__header__return')
        const toggleEditTaskForm = jest.spyOn(
          wrapper.vm,
          'toggleEditTaskFormAction'
        )
        await returnButton.trigger('click')
        expect(toggleEditTaskForm).toHaveBeenCalled()
      })
    })
    ...
    describe('Form title', () => {
      ...
      it('should render the correct form title', () => {
        const title = i18n.global.t('update.task.page.title')
        const formTitle = wrapper.find('.task__header__title')
    ...
    describe('Confirm Button', () => {
      ...
      it('should call the updateTaskAction method when clicked', async () => {
        const confirmButton = wrapper.find('.task__add-button')
        const addGoal = jest.spyOn(wrapper.vm, 'updateTaskAction')
